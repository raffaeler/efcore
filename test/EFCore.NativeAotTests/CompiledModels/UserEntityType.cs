    ...
    internal partial class UserEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType? baseEntityType = null)
        {
            ...
            id.SetAccessors(new PropertyAccessors(
                (IUpdateEntry e) =>
                    ((User)((InternalEntityEntry)e).Entity).Id == 0
                        ? ((InternalEntityEntry)e).ReadStoreGeneratedValue<int>(0) == 0
                            ? ((InternalEntityEntry)e).ReadTemporaryValue<int>(0) == 0
                                ? ((User)((InternalEntityEntry)e).Entity).Id
                                : ((InternalEntityEntry)e).ReadTemporaryValue<int>(0)
                            : ((InternalEntityEntry)e).ReadStoreGeneratedValue<int>(0)
                        : ((User)((InternalEntityEntry)e).Entity).Id,
                (IUpdateEntry e) =>
                    ((User)((InternalEntityEntry)e).Entity).Id == 0
                        ? ((InternalEntityEntry)e).ReadTemporaryValue<int>(0) == 0
                            ...
                            : ((InternalEntityEntry)e).ReadTemporaryValue<int>(0)
                        : ((User)((InternalEntityEntry)e).Entity).Id,
                (IUpdateEntry e) => ((InternalEntityEntry)e).ReadOriginalValue<int>(id, 0),
                (IUpdateEntry e) => ((InternalEntityEntry)e).ReadRelationshipSnapshotValue<int>(id, 0),
            ...
            name.SetAccessors(new PropertyAccessors(
                (IUpdateEntry e) => ((User)((InternalEntityEntry)e).Entity).Name,
                (IUpdateEntry e) => ((User)((InternalEntityEntry)e).Entity).Name,
                (IUpdateEntry e) => ((InternalEntityEntry)e).ReadOriginalValue<string>(name, 1),
                (IUpdateEntry e) => ((InternalEntityEntry)e).ReadRelationshipSnapshotValue<string>(name, 1),
