...
public sealed partial class InternalEntityEntry : IUpdateEntry
{
        ...
        object entity)
    {
        ...
        Entity = entity;
        _shadowValues = ((IRuntimeEntityType)entityType).EmptyShadowValuesFactory();
    ...
    public TProperty GetCurrentValue<TProperty>(IPropertyBase propertyBase)
        => ((Func<IUpdateEntry, TProperty>)propertyBase.GetPropertyAccessors().CurrentValueGetter)(this);
    ...
    public TProperty GetOriginalValue<TProperty>(IProperty property)
        => ((Func<IUpdateEntry, TProperty>)property.GetPropertyAccessors().OriginalValueGetter!)(this);
