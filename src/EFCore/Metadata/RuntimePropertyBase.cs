...
public abstract class RuntimePropertyBase : AnnotatableBase, IRuntimePropertyBase
{
    ...
    /// </summary>
    [EntityFrameworkInternal]
    public void SetAccessors(PropertyAccessors accessors)
    {
    ...
    /// </summary>
    [EntityFrameworkInternal]
    public void SetSetter<TEntity, TValue>(Action<TEntity, TValue> setter)
        where TEntity : class
    {
    ...
    /// </summary>
    [EntityFrameworkInternal]
    public void SetGetter<TEntity, TValue>(Func<TEntity, TValue> getter, Func<TEntity, bool> hasDefaultValue)
        where TEntity : class
    {
